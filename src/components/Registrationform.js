...
<h2 className='my-4' style={{color:'white'}}>Registration form to Search movie</h2>
<div className={validation.email.isInvalid && 'has-error'}>
<label htmlFor="full_name" style={{color:'white'}}>Full Name</label>
...
<label htmlFor="phone" style={{color:'white'}}>Phone(enter only 10 digit number)</label>
...
<label htmlFor="password_confirmation" style={{color:'white'}}>Confirm Password</label>
...
<button onClick={this.handleFormSubmit} className="btn btn-primary my-4"> Register </button>
</form>
</div>
</div>
</div>
